const translation = {
  ...
  newApp: {
    ...
    workflowDescription: '以任务的形式编排生成型应用，提供更多的自定义能力。 它适合有经验的用户。',
    workflowWarning: '正在进行 Beta 测试',
    chatbotType: '聊天助手编排方法',
    basic: '基础编排',
    // basicTip: '新手适用，可以切换成工作流编排',
    basicTip: '新手适用，可以切换成任务编排',
    basicFor: '新手适用',
    ...
    advancedDescription: '任务编排以任务的形式编排聊天机器人，提供高度的自定义，包括编辑内置提示的能力。 它适合有经验的用户。',
    captionName: '图标 & 名称',
  ...
  switchTipStart: '将为您创建一个使用任务编排的新应用。新应用将',
  switchTip: '不能够',
