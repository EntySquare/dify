        ...
        {isShowIterationDetail
          ...
          : (
            <>
              ...
              <div className={cn(
                'grow bg-tgai-panel-background h-0 overflow-y-auto rounded-b-2xl tgai-custom-scrollbar',
                (currentTab === 'RESULT' || currentTab === 'TRACING') && '!bg-gray-50 dark:!bg-tgai-panel-background-2',
              )}>
                ...
                {currentTab === 'TRACING' && !workflowRunningData?.tracing?.length && (
                  <div className='flex h-full items-center justify-center bg-gray-50 dark:bg-tgai-panel-background-2'>
                    <Loading />
                  </div>
                )}
