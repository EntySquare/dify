        ...
        <WrapElem onClick={() => {
          ...
          <>
            {isAddBtnTrigger
              ...
              : (<div ref={!isSupportConstantValue ? triggerRef : null} className={cn((open || isFocus) ? 'border-gray-300 dark:border-stone-600' : 'border-gray-100 dark:border-tgai-input-background', 'relative group/wrap flex items-center w-full h-8', !isSupportConstantValue && 'p-1 rounded-lg bg-gray-100 dark:bg-tgai-input-background border', isInTable && 'bg-transparent border-none')}>
                {isSupportConstantValue
                  ? <div onClick={(e) => {
                    e.stopPropagation()
                    setOpen(false)
