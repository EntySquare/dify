              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className='w-full h-10 px-3 text-sm font-normal border border-transparent bg-tgai-input-background text-tgai-text-1 rounded-lg grow outline-none focus:bg-components-input-bg-active dark:focus:bg-zinc-600 focus:border-components-input-border-active dark:focus:border-stone-600 focus:shadow-xs dark:focus:shadow-stone-800'
