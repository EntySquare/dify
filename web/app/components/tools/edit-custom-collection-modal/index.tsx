...
const fieldNameClassNames = 'py-2 leading-5 text-sm font-medium text-tgai-text-1'
type Props = {
      ...
      <Drawer
        ...
        body={
          <div className='flex flex-col h-full'>
            <div className='grow h-0 overflow-y-auto px-6 py-3 space-y-4 tgai-custom-scrollbar'>
              <div>
                ...
                <div className='flex items-center justify-between gap-3'>
                  ...
                  <input
                    className='h-10 px-3 text-sm font-normal text-tgai-text-1 bg-tgai-input-background rounded-lg grow' placeholder={t('tools.createTool.toolNamePlaceHolder')!}
              ...
              <div className='select-none'>
                <div className='flex justify-between items-center'>
                  <div className='flex items-center'>
                    ...
                    <a
                      ...
                      className='flex items-center h-[18px] space-x-1  text-[#155EEF] dark:text-tgai-primary'
                    >
                ...
                <textarea
                  ...
                  className='w-full h-[240px] px-3 py-2 leading-4 text-xs font-normal text-tgai-text-1 bg-tgai-input-background rounded-lg overflow-y-auto tgai-custom-scrollbar'
              ...
              <div>
                ...
                <div className='rounded-lg border border-gray-200 dark:border-zinc-600 w-full overflow-x-auto'>
                  <table className='w-full leading-[18px] text-xs text-tgai-text-2 font-normal'>
                    <thead className='text-tgai-text-2 uppercase'>
                      <tr className={cn(paramsSchemas.length > 0 && 'border-b', 'border-gray-200 dark:border-zinc-600')}>
                    ...
                    <tbody>
                      {paramsSchemas.map((item, index) => (
                        <tr key={index} className='border-b last:border-0 border-gray-200 dark:border-zinc-600'>
                          ...
                          <td className="p-2 pl-3 text-tgai-text-2 w-[236px]">{item.summary}</td>
              ...
              <div>
                ...
                <div className='flex items-center h-9 justify-between px-2.5 bg-tgai-input-background rounded-lg cursor-pointer' onClick={() => setCredentialsModalShow(true)}>
                  <div className='text-sm font-normal text-tgai-text-1'>{t(`tools.createTool.authMethod.types.${credential.auth_type}`)}</div>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full h-10 px-3 text-sm font-normal bg-tgai-input-background text-tgai-text-1 rounded-lg grow' placeholder={t('tools.createTool.privacyPolicyPlaceholder') || ''} />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full h-10 px-3 text-sm font-normal bg-tgai-input-background text-tgai-text-1 rounded-lg grow' placeholder={t('tools.createTool.customDisclaimerPlaceholder') || ''} />
              </div>

            </div>
            <div className={cn(isEdit ? 'justify-between' : 'justify-end', 'mt-2 shrink-0 flex py-4 px-6 rounded-b-[10px] bg-tgai-section-background border-t border-black/5')} >
              {
                isEdit && (
                  <Button onClick={onRemove} className='text-red-500 border-red-50 dark:border-red-900 hover:border-red-500'>{t('common.operation.delete')}</Button>
                )
              }
