...
import { Tag03 } from '../../base/icons/src/vender/line/financeAndECommerce'
  ...
  return (
    ...
    >
      <div className='relative'>
        ...
        >
          <div className={cn(
            'flex items-center gap-1 px-3 h-9 rounded-lg border-[0.5px] border-transparent bg-tgai-input-background cursor-pointer hover:bg-gray-200 dark:hover:bg-zinc-600',
