...
import { Tag01 } from '../../base/icons/src/vender/line/financeAndECommerce'
...
const ProviderCard = ({
  ...
  return (
    <div className={cn('group col-span-1 bg-tgai-panel-background-3 border-2 border-solid border-transparent rounded-xl shadow-sm min-h-[160px] flex flex-col transition-all duration-200 ease-in-out cursor-pointer hover:shadow-lg', active && '!border-tgai-primary')} onClick={onSelect}>
      ...
      <div
        className={cn(
          'grow mb-2 px-[14px] max-h-[72px] text-xs leading-normal text-tgai-text-2',
      ...
      {collection.labels?.length > 0 && (
        <div className='flex items-center shrink-0 mt-1 pt-1 pl-[14px] pr-[6px] pb-[6px] h-[42px]'>
          <div className='relative w-full flex items-center gap-1 py-[7px] rounded-md text-tgai-text-2' title={labelContent}>
