              ...
              >
                <div className='mr-1 flex items-center'>
                  ...
                  {!item.embedding_available && (
                    <span className='ml-1 shrink-0 px-1 border border-gray-200 dark:border-stone-600 rounded-md text-tgai-text-3 text-xs font-normal leading-[18px]'>{t('dataset.unavailable')}</span>
                  )}
                </div>
                {
