...
const OperationBtn: FC<IOperationBtnProps> = ({
  ...
  return (
    <div
      className={cn(className, 'flex items-center rounded-md h-7 px-3 space-x-1 text-tgai-text-2 cursor-pointer hover:bg-gray-200 dark:hover:bg-zinc-600 select-none')}
      onClick={onClick}>
      <div>
        {iconMap[type]}
      </div>
