    ...
    <>
      ...
      >
        ...
        <div className='flex mt-2'>
          ...
          />
          <input className={`flex-grow rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-100 dark:bg-tgai-input-background text-tgai-text-1`}
        ...
        <textarea
          rows={3}
          className={`mt-2 pt-2 pb-2 px-3 rounded-lg bg-gray-100 dark:bg-tgai-input-background w-full ${s.settingsTip} text-tgai-text-1`}
        ...
        {(appInfo.mode === 'workflow' || appInfo.mode === 'advanced-chat') && <>
          <div className={`mt-6 mb-2 font-medium ${s.settingTitle} text-tgai-text-1 `}>{t(`${prefixSettings}.workflow.title`)}</div>
          <SimpleSelect
        ...
        {isChat && <> <div className={`mt-8 font-medium ${s.settingTitle} text-tgai-text-1`}>{t(`${prefixSettings}.chatColorTheme`)}</div>
          ...
          <input className={`w-full mt-2 rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-100 dark:bg-tgai-input-background text-tgai-text-1`}
