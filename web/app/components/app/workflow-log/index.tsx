...
const Logs: FC<ILogsProps> = ({ appDetail }) => {
  ...
  return (
    <div className='flex flex-col h-full'>
      <h1 className='text-md font-semibold text-tgai-text-1'>{t('appLog.workflowTitle')}</h1>
      <p className='flex text-sm font-normal text-tgai-text-3'>{t('appLog.workflowSubtitle')}</p>
