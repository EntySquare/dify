...
const HeatStatisticsPanel = React.memo(
  ({ data, isLoading }: HeatStatisticsPanelProps) => {
    return (
      <Card className={"px-4 col-span-1 xl:col-span-2"} loading={isLoading}>
        <div
          style={{ width: "100%" }}
          className="flex items-centergap-0 divide-x"
        >
          <div
            className="w-1/4 h-20 flex items-center px-5"
            style={{
