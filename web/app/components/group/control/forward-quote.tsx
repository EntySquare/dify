...
export type ForwardQuoteModalType = string;

type ForwardQuoteModalProps = {
  //   tweetsUrl: string | undefined;
};

export type ForwardQuoteModalRefType = {
  show: () => Promise<ForwardQuoteModalType | false>;
};

const ForwardQuoteModal = React.forwardRef<
  ForwardQuoteModalRefType,
  ForwardQuoteModalProps
>(({}, ref) => {
  ...
  const promiseRef = useRef<{
    resolve: (value: ForwardQuoteModalType | false) => void;
  }>();
...
ForwardQuoteModal.displayName = "ForwardQuoteModal";

export { ForwardQuoteModal };
