...
const ChatInputArea = ({
  ...
  return (
    <>
      ...
      >
        <div className='relative px-[9px] pt-[9px] max-h-[158px] overflow-x-hidden overflow-y-auto tgai-custom-scrollbar'>
          ...
          >
            <div className='flex items-center relative grow w-full'>
              ...
              <Textarea
                ref={textareaRef}
                className={cn(
                  'p-1 w-full leading-6 body-lg-regular text-text-tertiary outline-none bg-components-panel-bg-blur',
                )}
