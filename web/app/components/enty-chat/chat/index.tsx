  ...
  return (
    ...
    >
      <div className='relative h-full'>
        ...
        <div
          className={`absolute bottom-0 ${(hasTryToAsk || !noChatInput || !noStopResponding) && chatFooterClassName} bg-gradient-to-t from-[#F9FAFB] dark:from-[rgba(29,_29,_32,_1)] from-[60%] to-[rgba(255,_255,_255,_0.00)] dark:to-[rgba(0,_0,_0,_0.00)] to-100%`}
          ref={chatFooterRef}
        >
          <div
