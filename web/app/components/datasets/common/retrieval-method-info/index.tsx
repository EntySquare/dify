...
import {
  PatternRecognition,
  Semantic,
} from "../../../base/icons/src/vender/solid/development";
  ...
  return (
    <div className="space-y-2">
      <RadioCard
          ...
          <div className="flex flex-wrap leading-[18px] text-xs font-normal">
            {value.reranking_model.reranking_model_name && (
              <div className="mr-8 flex space-x-1">
                ...
                <div className="font-medium text-tgai-text-1">
                  {value.reranking_model.reranking_model_name}
                </div>
              </div>
            )}
            ...
            <div className="mr-8 flex space-x-1">
              ...
              <div className="font-medium text-tgai-text-1">{value.top_k}</div>
            </div>
        ...
        className="dark:!bg-neutral-700 dark:!border-stone-600"
      />
    </div>
  );
};
