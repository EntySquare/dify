...
} from "../../common/check-rerank-model";
...
import { MessageChatSquare } from "../../../base/icons/src/public/common";
...
const StepTwo = ({
  ...
  return (
    <div className="flex w-full h-full">
      <div
        ref={scrollRef}
        className="relative h-full w-full pb-12 overflow-y-scroll tgai-custom-scrollbar"
      >
        <div
          className={cn(
            s.pageHeader,
                  ...
                  <div className={s.formRow}>
                    <div className="w-full">
                      ...
                      <input
                        ...
                        className={cn(
                          s.input,
                          "dark:!bg-tgai-input-background dark:focus:!ring-tgai-input-background dark:focus:!bg-zinc-600 dark:!text-tgai-text-1",
                        )}
                        placeholder={
                  ...
                  <div className={s.formRow}>
                    <div className="w-full">
                      ...
                      <input
                        ...
                        className={cn(
                          s.input,
                          "dark:!bg-tgai-input-background dark:focus:!ring-tgai-input-background dark:focus:!bg-zinc-600 dark:!text-tgai-text-1 dark:!caret-tgai-primary",
                        )}
                        placeholder={
                          t("datasetCreation.stepTwo.maxLength") || ""
                        }
                  ...
                  <div className={s.formRow}>
                    <div className="w-full">
                      <div className={cn(s.label, "dark:!text-tgai-text-1")}>
                        ...
                        >
                          <RiQuestionLine className="ml-1 w-3.5 h-3.5 text-tgai-text-3" />
                        </TooltipPlus>
                      </div>
                      <input
                        type="number"
                      ...
                      {rules.map((rule) => (
                        <div key={rule.id} className={s.ruleItem}>
                          <input
                            ...
                            className="w-4 h-4 rounded border-gray-300 dark:border-stone-500 text-blue-700 dark:text-tgai-primary focus:ring-blue-700 dark:focus:ring-tgai-primary accent-tgai-primary"
                          />
                          <label
                            htmlFor={rule.id}
                            className="ml-2 text-sm font-normal cursor-pointer text-tgai-text-1"
                          >
                            {getRuleName(rule.id)}
                          </label>
                        </div>
                ...
                (hasSetIndexType &&
                  ...
                  >
                    ...
                    <div className={s.typeHeader}>
                      ...
                      <div className={cn("pb-0.5 text-xs font-medium text-tgai-text-3", (!isAPIKeySet || hasSetIndexType) && "dark:group-hover:!text-tgai-text-4")}>
                        {t("datasetCreation.stepTwo.emstimateCost")}
                      </div>
                      {estimateTokes ? (
                        <div className={cn("text-xs font-medium text-tgai-text-1", (!isAPIKeySet || hasSetIndexType) && "dark:group-hover:!text-tgai-text-4")}>
                ...
                (hasSetIndexType &&
                  ...
                  >
                    ...
                    <div className={s.typeHeader}>
                      ...
                      <div className={cn("pb-0.5 text-xs font-medium text-tgai-text-3", hasSetIndexType && "dark:group-hover:!text-tgai-text-4")}>
                        {t("datasetCreation.stepTwo.emstimateCost")}
                      </div>
                      <div className={cn("text-xs font-medium text-tgai-text-1", hasSetIndexType && "dark:group-hover:!text-tgai-text-4")}>
                        0 tokens
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-3 rounded-xl bg-gray-50 dark:bg-neutral-700 border border-gray-100 dark:border-stone-700">
                <div className="flex justify-between items-center px-5 py-4">
                  ...
                  <div className="grow mx-3">
                    <div className="mb-[2px] text-md font-medium text-tgai-text-1">
                ...
                {docForm === DocForm.QA && !QATipHide && (
                  <div className="flex justify-between items-center px-5 py-2 bg-orange-50 dark:bg-orange-900 border-t border-amber-100 dark:border-amber-800 rounded-b-xl text-[13px] leading-[18px] text-medium text-amber-500 dark:text-amber-400">
                    ...
                    <RiCloseLine
                      className="w-4 h-4 text-gtgai-text-3 cursor-pointer"
            ...
            <div>
              {!datasetId ? (
                <div className={cn(s.label, "dark:!text-tgai-text-1")}>
                  ...
                  {/* <div className="leading-[18px] text-xs font-normal text-gray-500">
                    <a
                      ...
                      href="https://docs.dify.ai/guides/knowledge-base/create-knowledge-and-upload-documents#id-6-retrieval-settings"
                ...
                <div
                  className={cn(
                    s.label,
                    "flex justify-between items-center dark:!text-tgai-text-2",
                  )}
                >
        ...
        {showPreview && (
          <div
            ...
            className={cn(
              s.previewWrap,
              isMobile && s.isMobile,
              "relative h-full overflow-y-scroll border-l border-[#F2F4F7] dark:border-stone-600 tgai-custom-scrollbar",
            )}
          >
            <div
              className={cn(
                s.previewHeader,
                "dark:!bg-tgai-panel-background-2",
                previewScrolled && `${s.fixed} pb-3`,
              )}
            >
              <div className="flex items-center justify-between px-8">
                <div className="grow flex items-center">
                  <div className="text-tgai-text-1">
