...
const PreviewItem: FC<IPreviewItemProps> = ({
  ...
  return (
    <div className="p-4 rounded-xl bg-gray-50 dark:bg-tgai-panel-background-4">
      <div className="flex items-center justify-between h-5 text-xs text-tgai-text-2">
        <div className="flex items-center h-[18px] space-x-1 border border-gray-200 dark:border-stone-600 box-border rounded-md italic pl-1 pr-1.5 font-medium">
          {sharpIcon}
      ...
      <div className="mt-2 max-h-[120px] line-clamp-6 overflow-hidden text-sm text-tgai-text-1">
        {type === PreviewType.TEXT && (
        ...
        {type === PreviewType.QA && (
          <div style={{ whiteSpace: "pre-line" }}>
            <div className="flex">
              <div className="shrink-0 mr-2 text-medium text-tgai-text-3">Q</div>
              <div style={{ whiteSpace: "pre-line" }}>{qa?.question}</div>
            </div>
            <div className="flex">
              <div className="shrink-0 mr-2 text-medium text-tgai-text-3">A</div>
