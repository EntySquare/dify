...
import type { DefaultModel } from "../../../header/account-setting/model-provider-page/declarations";
...
`;
const inputClass = `
  w-full max-w-[480px] px-3 bg-gray-100 dark:bg-tgai-input-background text-sm text-tgai-text-1 rounded-lg outline-none appearance-none
`;
    ...
    <div className="w-full sm:w-[800px] p-4 sm:px-16 sm:py-6">
      ...
      <div className={rowClass}>
        ...
        <div className="w-full max-w-[480px]">
          ...
          />
          {/* <a
            className="flex items-center h-[18px] px-3 text-xs text-tgai-text-3"
