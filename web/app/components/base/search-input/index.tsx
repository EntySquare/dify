  ...
  return (
    <div
      className={cn(
        ...
        !focus &&
          value &&
          "hover:!bg-gray-200 hover:!shawdow-xs hover:!border-black/5",
        white &&
          "!bg-white hover:!bg-white shawdow-xs !border-gray-300 hover:!border-gray-300",
        dark &&
          "!bg-tgai-input-background hover:!bg-tgai-input-background shadow-xs !border-zinc-600 hover:!border-zinc-600",
        className,
      )}
    >
      <div className="pointer-events-none shrink-0 flex items-center mr-1.5 justify-center w-4 h-4">
        <RiSearchLine
          className="h-3.5 w-3.5 text-tgai-text-3"
          aria-hidden="true"
        />
      </div>
      <input
        ...
        className={cn(
          ...
          focus &&
            "!bg-white hover:bg-white group-hover:bg-white placeholder:!text-gray-400",
          !focus && value && "hover:!bg-gray-200 group-hover:!bg-gray-200",
          white &&
            "!bg-white hover:!bg-white group-hover:!bg-white placeholder:!text-gray-400",
          dark &&
            "!bg-tgai-input-background hover:!bg-tgai-input-background group-hover:!bg-tgai-input-background placeholder:!text-tgai-text-2 !caret-tgai-primary",
        )}
