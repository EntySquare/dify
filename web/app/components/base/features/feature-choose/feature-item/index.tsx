...
const FeatureItem: FC<IFeatureItemProps> = ({
  ...
  return (
    <div className={cn(s.wrap, 'relative flex justify-between p-3 rounded-xl border border-transparent bg-gray-50 dark:bg-neutral-600 hover:border-gray-200 dark:hover:border-stone-600 cursor-pointer')}>
      <div className='flex space-x-3 mr-2'>
        {/* icon */}
        <div
          className='shrink-0 flex items-center justify-center w-8 h-8 rounded-lg border border-gray-200 dark:border-stone-600 bg-white dark:bg-neutral-500'
          style={{
        ...
        <div>
          ...
          <div className='text-xs font-normal text-tgai-text-2'>{description}</div>
        </div>
      </div>
