...
const Moderation = ({
  ...
  return (
    <div className='flex items-center px-3 h-12 bg-gray-50 dark:bg-neutral-700 rounded-xl overflow-hidden'>
      ...
      <div
        className='grow block w-0 text-right text-xs text-tgai-text-3 truncate'
        title={renderInfo()}>
        {renderInfo()}
      </div>
      <div className='shrink-0 ml-4 mr-1 w-[1px] h-3.5 bg-gray-200 dark:bg-zinc-600'></div>
      <div
        className={`
          shrink-0 flex items-center px-3 h-7 cursor-pointer rounded-md
          text-xs text-tgai-text-2 font-medium hover:bg-gray-200 dark:hover:bg-zinc-600
