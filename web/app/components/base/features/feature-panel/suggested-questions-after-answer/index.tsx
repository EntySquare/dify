...
import { MessageSmileSquare } from '../../../icons/src/vender/solid/communication'
...
const SuggestedQuestionsAfterAnswer: FC = () => {
  ...
  return (
    <div className='flex items-center px-3 h-12 bg-gray-50 dark:bg-neutral-700 rounded-xl overflow-hidden'>
      ...
      <div className='text-xs text-tgai-text-2'>{t('appDebug.feature.suggestedQuestionsAfterAnswer.resDes')}</div>
    </div>
  )
}
