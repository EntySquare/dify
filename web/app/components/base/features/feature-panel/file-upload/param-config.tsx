  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => !disabled && setOpen(v => !v)}>
        <div className={cn('flex items-center rounded-md h-7 px-3 space-x-1 text-tgai-text-2 cursor-pointer hover:bg-gray-200 dark:hover:bg-zinc-600', open && 'bg-gray-200 dark:bg-zinc-600', disabled && 'cursor-not-allowed opacity-50')}>
