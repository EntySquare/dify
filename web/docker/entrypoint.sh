...
export NEXT_PUBLIC_XAI_API_PREFIX=${X_API_3021}/api
export NEXT_PUBLIC_TGAI_API_PREFIX=${TG_API_3010}/api
export NEXT_PUBLIC_TGAI_WS_PREFIX=${TG_API_WS_3010}/api/channelJoinOrLeaveWS
