...
XAI_GENERATE_TWEETS_TEMPLATE_PATH = "adminApi/chat/template/tweetArr"


class XAIGenerateTweetsResponseTemplate(BuiltinTool):
    ...
    def _invoke(self,
        ...
        url = URL(api_url) / "api" / XAI_GENERATE_TWEETS_TEMPLATE_PATH if 'api' not in api_url else URL(api_url) / XAI_GENERATE_TWEETS_TEMPLATE_PATH
